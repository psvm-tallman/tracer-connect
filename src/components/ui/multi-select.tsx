  ...
  return (
    ...
    >
      <Command
        ...
        className={cn(
          "overflow-visible z-50 flex flex-col space-y-2",
          className
        )}
        dir={dir}
        {...props}
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2 border border-muted rounded-lg z-50 bg-white",
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-white z-50 outline-none flex-1",
        className,
...
>(({ className, children }, ref) => {
  return (
    <CommandList
      ref={ref}
      className={cn(
        "p-2 flex flex-col gap-2 bg-white rounded-md w-full absolute z-10 border top-0",
        className
      )}
    >
      {children}
